...
public class Challenge1 {
    ...
    public static void main(String[] args) {
        ...
        String msg = "Your last name appears to be (assumes the last word "
     ...
     * is the last name. It must be assumed so. Be careful.
     *
     * @param fullName a multi-part entry representing a full name
     * @return
     * @throws IllegalArgumentException if full name is null, or full name is
     ...
     * part is definitely a last name, so we will assume that it is.
     */
